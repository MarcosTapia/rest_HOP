<?php
/**
 * Actualiza una maquina especificado por su identificador
 */
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $retorno = Maquinas::update($body['idMaquina'],$body['numeroMaquina'],
            $body['nombreMaquina'],$body['idEtapa'],$body['idArea']);
    if ($retorno) {
